(function(){
    ...
    */
    ...
    cpfs.forEach(function(item){
        console.log(clearCPF(item).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,'$1.$2.$3-$4'));
    })
    ...
    */
    ...
    var tagVazia = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';

    console.log(tagVazia.match(/<\w+><\/\w+>/g))
    ...
    */
    ...
    var textTag = '<h1>Titulo da pagina</h1><p> Este é um paragrafo</p><footer>Rodapé</footer>';

    console.log(textTag.replace(/(<(\w+)>)([^<]+)(<\/\w+>)/g,'$1O texto da tag "$2" é "$3"$4'));
