...
var quebrado = $a.reduce(function(acc,actual,index){
    return acc + actual.getAttribute('data-js') + (index+1)+' ';
},'');

console.log(DOM.prototype.isNull(1));
...
console.log(DOM.prototype.isObjectType());