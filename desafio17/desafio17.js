(function(){
    ...
    */
   var text = 'Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 - Rio de Janeiro . 18 de julho de 1875, apelidado de "O Centauro de Luvas", foi um militar, politico, abolicionista e monarquista brasileiro'
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/,'Marcos Vinicius dos Santos Nunes'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/gi,function(phrase){
