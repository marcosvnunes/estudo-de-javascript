(function(){
    ...
    */
    ...
    console.log(justNumbersRegex); ///^\d+/gm
    /*
    ...
    */
    ...
    console.log(text.match(justNumbersRegex)); //  ["10", "50"]
    ...
    */
    ...
    console.log(numbersAtTheEnd); ///\d+$/gm
    /*
    ...
    */
    ...
    console.log(otherText.match(numbersAtTheEnd)); // ["12", "6"]
    ...
    */
    ...
    function hasClass(markup,cssClass){
        var reg = new RegExp('class=[\'"\\s\\w]+?'+cssClass+'[\'"\\s]');
